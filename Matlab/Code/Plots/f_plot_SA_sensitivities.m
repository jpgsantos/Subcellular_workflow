...
bar(a,[transpose(rst.SI.st(:,1:stg.ms.parnum)),...
    transpose(rst.SIT.st(:,1:stg.ms.parnum)),...
    transpose(rst.SIT.st(:,1:stg.ms.parnum)-rst.SI.st(:,1:stg.ms.parnum))])
xlabel('Parameters');
ylabel('Sensitivity');
