...
%             fullFileName = sprintf('%s.m',stg.folder_main + "/Model/" +...
...
%             fprintf(fileID, "Data = coder.load('" + stg.folder_main + "/Model/" +...
            fprintf(fileID, "Data = coder.load('" + pwd + "/Model/" +...                
...
% fullFileName = sprintf('%s.m',stg.folder_main + "/Model/" + stg.folder_model +...
...
%                 fprintf(fileID, "load('" + stg.folder_main + "/Model/" + stg.folder_model +...
                fprintf(fileID, "load('" + pwd + "Model/" + stg.folder_model +...                    
                ...
                fprintf(fileID, "exp" + exp_n + "_" + name +...
                    ...
                    ").input_value{" + n + "};\n");
%                 fprintf(fileID, "save('" + stg.folder_main + "/Model/" + stg.folder_model +...
                fprintf(fileID, "save('" + pwd + "/Model/" + stg.folder_model +...                    
