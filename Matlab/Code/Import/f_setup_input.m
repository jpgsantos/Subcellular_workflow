...
for exp_n = 1:size(sbtab.datasets,2)
    ...
    for n = 1:size(sbtab.datasets(exp_n).input,2)
        if size(sbtab.datasets(exp_n).input_value{n},2) > 100
            ...
            fprintf(fileID, "Data = coder.load('" + strrep(script_folder,"\","/") + "/Model/" +...
...
fullFileName = sprintf('%s.m',script_folder + "/Model/" + stg.folder_model +...
    ...
    for n =1:size(sbtab.datasets(exp_n).input,2)
        if size(sbtab.datasets(exp_n).input_value{n},2) > 100
            ...
            if n == 1 && exp_n == helper2
                ...
                fprintf(fileID, "load('" + strrep(script_folder,"\","/") + "/Model/" + stg.folder_model +...
                ...
                fprintf(fileID, "exp" + exp_n + "_" + name +...
                    ...
                    ").input_value{" + n + "};\n");
                fprintf(fileID, "save('" + strrep(script_folder,"\","/") + "/Model/" + stg.folder_model +...
