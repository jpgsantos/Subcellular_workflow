function [stg,sb] = f_generate_sbtab_struct(stg,script_folder)

if isfile(script_folder + "/Model/" + stg.folder_model +"/Data/" +...
        stg.sbtab_name + ".mat")
    
    load(script_folder + "/Model/" + stg.folder_model +"/Data/" +...
