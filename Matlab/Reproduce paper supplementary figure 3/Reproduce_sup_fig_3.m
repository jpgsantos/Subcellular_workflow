load("Reproduce paper supplementary figure 3/Copasi_simulation_results.mat")
load("Reproduce paper supplementary figure 3/Analysis.mat")
...
load("Reproduce paper supplementary figure 3/data_Viswan_2018_optimized.mat",'Data','sbtab')
...
if f_check_minimum_version(9,8)
    ...
    exportgraphics(layout,...
        'Reproduce paper supplementary figure 3/supplementary figure 3.png',...
        'Resolution',600)
    
    exportgraphics(layout,...
        'Reproduce paper supplementary figure 3/supplementary figure 3.tiff',...
        'Resolution',600)
    
    exportgraphics(layout,...
        'Reproduce paper supplementary figure 3/supplementary figure 3.pdf',...
        'ContentType','vector')
end
...
if isempty(Data)
    load("Reproduce paper supplementary figure 1/data_Viswan_2018_optimized.mat",'Data','sbtab','sb')
end
