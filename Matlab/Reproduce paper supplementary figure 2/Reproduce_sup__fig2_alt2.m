...
% legend boxoff
title('Importatnt parameters S_i > 0','FontSize', 8,'Fontweight','bold')
...
% legend({'Si'},'Location','best');
% legend boxoff
title('Unimportatnt parameters S_i ~ 0','FontSize', 8,'Fontweight','bold')
...
% legend boxoff
title('Important parameters S_T_i > 0','FontSize', 8,'Fontweight','bold')
...
% legend({'SiT'},'Location','best');
% legend boxoff
title('Unimportatnt parameters S_T_i ~ 0','FontSize', 8,'Fontweight','bold')
...
if f_check_minimum_version(9,8)
        ...
        exportgraphics(layout,...
            'Reproduce paper supplementary figure 2/Supplementary figure 2 alt2_Si and SiT.png',...
            'Resolution',600)
    
        exportgraphics(layout,...
            'Reproduce paper supplementary figure 2/Supplementary figure 2 alt2_Si and SiT.tiff',...
            'Resolution',600)
    
        exportgraphics(layout,...
            'Reproduce paper supplementary figure 2/Supplementary figure 2 alt2_Si and SiT.pdf',...
            'ContentType','vector')
end