clear
clc
work_folder = pwd + "/Reproduce paper supplementary figure 4/Results";
...
j=1;
for i=1:length(results_file_name)
    if results_file_name(i).isdir&&(~ismember(results_file_name(i).name,{'.','..','2021-03-03_16-48-46'}))
...
if f_check_minimum_version(9,8)
    ...
    exportgraphics(layout,...
        'Reproduce paper supplementary figure 4/supplementary figure 4.png',...
        'Resolution',600)
    
    exportgraphics(layout,...
        'Reproduce paper supplementary figure 4/supplementary figure 4.tiff',...
        'Resolution',600)
    
    exportgraphics(layout,...
        'Reproduce paper supplementary figure 4/supplementary figure 4.pdf',...
        'ContentType','vector')
end
