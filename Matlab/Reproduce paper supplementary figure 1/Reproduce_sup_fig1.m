load("Reproduce paper supplementary figure 1/Analysis.mat")
...
load("Reproduce paper supplementary figure 1/data_Viswan_2018_optimized.mat",'Data','sbtab')
...
if f_check_minimum_version(9,8)
    ...
    exportgraphics(layout,...
        'Reproduce paper supplementary figure 1/supplementary figure 1.png',...
        'Resolution',600)
    
    exportgraphics(layout,...
        'Reproduce paper supplementary figure 1/supplementary figure 1.tiff',...
        'Resolution',600)
    
    exportgraphics(layout,...
        'Reproduce paper supplementary figure 1/supplementary figure 1.pdf',...
        'ContentType','vector')
end
