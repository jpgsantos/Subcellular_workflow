...
# ones.
extensions = ['sphinx.ext.mathjax','recommonmark','sphinx.ext.intersphinx','sphinxcontrib.contentui','sphinx.ext.viewcode', 'sphinx.ext.autodoc','sphinx_markdown_tables']
