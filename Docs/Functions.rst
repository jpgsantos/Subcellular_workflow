...
The MATLAB U+2122 functions used in this workflow are divided acording to their role, we have:

  - :ref:`Functions to import the model to MATLAB U+2122 and generate model specific files and functions<functions_import>`
