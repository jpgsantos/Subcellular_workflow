...
The MATLAB section of this workflow has been developed to facilitate model building and rapid iteration between different versions of a model.
...
This documentation is divided in: 
  ...
  - :ref:`Model files and folders<files>` - Description of all the files and folders that are generated when the model is "imported" from SBtab into relevant files, used by the rest of the MATLAB code.
