...
load("./model_Nair_2016_optimized_fig7.mat",'modelobj');
obj = modelobj;
...
set(obj.Parameters(233), 'Value', 28.42)
set(obj.species(25), 'InitialAmount', 28.42)

[t,species,names] = sbiosimulate(obj);
% Steady_state = readtable('steady_states.csv');
% Steady_State = Steady_state(2:end,2);

% for i=1:99
%     set(obj.species(i), 'InitialAmount', Steady_State(i,1).Variables);
% end
...
save("./Nair_2016_optimized_Matlab_data_fig7.mat",...
