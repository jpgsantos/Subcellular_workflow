...
xlim ([0 1000])
legend(["300 seconds","2400 seconds"],'FontSize', 6.5,'Fontweight','bold');
legend boxoff
...
exportgraphics(layout,...
    folder + "supplementary figure 5_alt2.png",...
    'Resolution',600)

exportgraphics(layout,...
    folder + "supplementary figure 5_alt2.tiff",...
    'Resolution',600)

exportgraphics(layout,...
    folder + "supplementary figure 5_alt2.pdf",...
    'ContentType','vector')
% end
end
