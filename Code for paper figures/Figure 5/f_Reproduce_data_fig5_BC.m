...
ruleobj=addrule(obj, 'Spine.Ca = Ca_input_fig5(time)');
...
Nair_2016_optimized_Matlab_data_fig5{1}(:,1) = t_noDA;
Nair_2016_optimized_Matlab_data_fig5{1}(:,2) = x_noDA;
Nair_2016_optimized_Matlab_data_fig5{2}(:,1) = t_DA;
Nair_2016_optimized_Matlab_data_fig5{2}(:,2) = x_DA;
Nair_2016_optimized_Matlab_data_fig5{3}(:,1) = DA;
Nair_2016_optimized_Matlab_data_fig5{3}(:,2) = ...
    activationAreaWithMultipleDA/activationArea;

save(folder + "Nair_2016_optimized_Matlab_data_fig5.mat",...
