...
f_Reproduce_sup_fig3(script_folder + "Reproduce paper supplementary figure 3/")
f_Reproduce_sup_fig4(script_folder + "Reproduce paper supplementary figure 4/")
% f_Reproduce_sup_fig5(script_folder + "Reproduce paper supplementary figure 5/")
% f_Reproduce_sup_fig5_alt2(script_folder + "Reproduce paper supplementary figure 5/")
f_Reproduce_sup_fig5_alt3(script_folder + "Reproduce paper supplementary figure 5/")