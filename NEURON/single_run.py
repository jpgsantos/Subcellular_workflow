...
for spine in d1.spines:
    spine.head(0.5).D1_LTP_time_window.DA_max = 20
...
for spine in d1.spines:
    ...
    spine.head(0.5).D1_LTP_time_window.DA_start = p.plateau_burst_start - 1333
...
for spine in d1.spines:
    spine.head(0.5).D1_LTP_time_window.DA_max = p.DA_max
    spine.head(0.5).D1_LTP_time_window.DA_start = p.plateau_burst_start + 1000
