...
#define nrn_init _nrn_init__glutamate_phos
#define _nrn_initial _nrn_initial__glutamate_phos
#define nrn_cur _nrn_cur__glutamate_phos
#define _nrn_current _nrn_current__glutamate_phos
#define nrn_jacob _nrn_jacob__glutamate_phos
#define nrn_state _nrn_state__glutamate_phos
#define _net_receive _net_receive__glutamate_phos 
#define calculate_weights calculate_weights__glutamate_phos 
#define state state__glutamate_phos 
...
#define eta _p[8]
#define q _p[9]
#define w_ampa0 _p[10]
#define w_nmda0 _p[11]
#define tau_i _p[12]
#define total_Substrate _p[13]
#define i _p[14]
#define g _p[15]
#define i_ampa _p[16]
#define i_nmda _p[17]
...
#define MgBlock MgBlock_glutamate_phos
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 glutamate_phos C:/Users/kadpaj/OneDrive - KI.SE/Skrivbordet/Models/Subcellular_workflow/NEURON/mod/glutamate_phos.mod\n");
...
/*CVODE*/
 static int _ode_spec1 () {_reset=0;
 {
   ...
   DC = - C / tau1_ampa ;
   DD = - D / tau2_ampa ;
   Dintegral = ( pSubstrate - integral ) / tau_i ;
   }
 return _reset;
}
 ...
 Dintegral = Dintegral  / (1. - dt*( ( ( ( - 1.0 ) ) ) / tau_i )) ;
  return 0;
}
 /*END CVODE*/
 static int state () {_reset=0;
 {
    ...
    integral = integral + (1. - exp(dt*(( ( ( - 1.0 ) ) ) / tau_i)))*(- ( ( ( pSubstrate ) ) / tau_i ) / ( ( ( ( - 1.0 ) ) ) / tau_i ) - integral) ;
   }
  return 0;
}
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 142 in file glutamate_phos.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
static void _initlists() {
 ...
 _slist1[4] = &(integral) - _p;  _dlist1[4] = &(Dintegral) - _p;
_first = 0;
}

#if NMODL_TEXT
static const char* nmodl_filename = "glutamate_phos.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
